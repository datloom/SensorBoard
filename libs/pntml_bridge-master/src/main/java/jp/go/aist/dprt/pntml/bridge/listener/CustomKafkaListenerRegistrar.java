...
import jp.go.aist.dprt.pntml.bridge.configuration.CustomKafkaListenerProperties;
...
public class CustomKafkaListenerRegistrar implements InitializingBean {
    ...
    public void registerCustomKafkaListener(String name, CustomKafkaListenerProperty customKafkaListenerProperty, boolean startImmediately) {
        String listenerClass = String.join(".",
                CustomKafkaListenerRegistrar.class.getPackageName(),
        ...
        kafkaListenerEndpointRegistry.registerListenerContainer(
                customMessageListener.createKafkaListenerEndpoint(
                        name,
                        customKafkaListenerProperty.getTopic()),
